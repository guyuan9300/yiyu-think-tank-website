...
export function ArticleEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose max-w-none focus:outline-none min-h-[280px] px-4 py-4 prose-p:my-4 prose-headings:my-5 prose-li:my-1 prose-ol:list-decimal prose-ul:list-disc prose-ol:list-inside prose-ul:list-inside prose-ol:pl-2 prose-ul:pl-2 [&_ol]:list-decimal [&_ul]:list-disc [&_ol]:list-inside [&_ul]:list-inside [&_ol]:pl-2 [&_ul]:pl-2 [&_ol>li]:list-item [&_ul>li]:list-item [&_li]:my-1 [&_figure]:my-6 [&_figure]:text-center [&_figure_img]:mx-auto [&_figure_img]:block [&_img]:mx-auto [&_img]:block',
      },
    },
    onUpdate: ({ editor }) => {
      onChange?.({
